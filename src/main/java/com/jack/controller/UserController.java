...
import com.jack.ForgotPasswordTokenRequest;
...
import com.jack.service.ForgotPasswordService;
...
public class UserController {
	...
	public ResponseEntity<ApiResponse> resetPassword(
		...
		if (isVerified) {
			userService.updatePassowrd(forgotPasswordToken.getUser(), req.getPassword());
			ApiResponse res = new ApiResponse();
			res.setMassage("password update successfully");
