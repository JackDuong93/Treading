...
import com.jack.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService {
	...
	public String getCoinDetails(String coinId) throws Exception {
		...
		try {
			...
			coin.setPriceChangePercentage24h(marketData.get(
					"price_change_percentage_24h").asDouble());	
			coin.setMarketCapChange24h(marketData
					.get("market_cap_change_24h").asLong());
			coin.setMarketCapChangePercentage24h(marketData
					.get("market_cap_change_percentage_24h").asLong());
